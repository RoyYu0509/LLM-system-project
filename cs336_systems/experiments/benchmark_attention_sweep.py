...
DEFAULT_TIERS = [
    ...
    ("seq2048-hd64-12h-8b",   2048,   2048,   64, 12, 4),
    ("seq4096-hd64-12h-8b",    4096,   4096,   64, 12, 4),
    ("seq8192-hd64-12h-8b",    8192,   8192,   64, 12, 4),
    ("seq16384-hd64-12h-8b",  16384,  16384,   64, 12, 4),

    # ==========================================
    # 
    # ==========================================
    
    ("seq2048-hd128-16h-32b",   2048,   2048,   768, 12, 4),
    ("seq4096-hd128-16h-32b",    4096,   4096,   768, 12, 4),
    ("seq8192-hd128-16h-32b",    8192,   8192,   768, 12, 4),
    ("seq16384-hd128-16h-32b",  16384,  16384,   768, 12, 4),

    # ==========================================
    # 
    # ==========================================
    
    ("seq2048-hd128-16h-32b",   2048,   2048,   1024, 16, 2),
    ("seq4096-hd128-16h-32b",    4096,   4096,   1024, 16, 2),
    ("seq8192-hd128-16h-32b",    8192,   8192,   1024, 16, 2),
    ("seq16384-hd128-16h-32b",  16384,  16384,   1024, 16, 2),
]
