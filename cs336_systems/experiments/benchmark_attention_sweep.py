...
DEFAULT_TIERS = [
    ...
    ("seq256-hd128-16h-32b",    256,    256,  64, 12, 8),
    ...
    ("seq256-hd128-16h-32b",    256,    256,   128, 16, 32),
    ...
    ("seq256-hd128-16h-32b",    256,    256,   768, 12, 32),
    ("seq512-hd128-16h-32b",    512,    512,   768, 12, 32),
    ("seq1024-hd128-16h-32b",   1024,   1024,   768, 12, 32),
    ("seq2048-hd128-16h-32b",   2048,   2048,   768, 12, 32),
    ("seq4096-hd128-16h-32b",    4096,   4096,   768, 12, 32),
    ("seq8192-hd128-16h-32b",    8192,   8192,   768, 12, 32),
    ("seq16384-hd128-16h-32b",  16384,  16384,   768, 12, 32),

    # ==========================================
    # 
    # ==========================================
    
    ("seq256-hd128-16h-32b",    256,    256,   1024, 16, 32),
    ("seq512-hd128-16h-32b",    512,    512,   1024, 16, 32),
    ("seq1024-hd128-16h-32b",   1024,   1024,   1024, 16, 32),
    ("seq2048-hd128-16h-32b",   2048,   2048,   1024, 16, 32),
    ("seq4096-hd128-16h-32b",    4096,   4096,   1024, 16, 32),
    ("seq8192-hd128-16h-32b",    8192,   8192,   1024, 16, 32),
    ("seq16384-hd128-16h-32b",  16384,  16384,   1024, 16, 32),
]
